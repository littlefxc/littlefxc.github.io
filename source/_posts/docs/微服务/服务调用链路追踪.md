...
![](https://gitee.com/littlefxc/oss/raw/master/images/1315495-20210124092812074-1348764625.png)
...
![](https://gitee.com/littlefxc/oss/raw/master/images/5e13fe4a0933db6c28121464.png)
...
![](https://gitee.com/littlefxc/oss/raw/master/images/5e13fe560945406628781494.png)
...
![](https://gitee.com/littlefxc/oss/raw/master/images/1620-20220511164950835.png)
...
实际场景中，我们需要知道某次请求调用的情况，所以只有spanid还不够，得为每次请求做个唯一标识，这样才能根据标识查出本次请求调用的所有服务，它就是从头到尾贯穿整个调用链的ID，我们叫它 Trace ID，不管调用链路中途访问了多少个服务节点，在每个节点的 log 中都会打印同一个 Trace ID。
  ...
  ![](https://gitee.com/littlefxc/oss/raw/master/images/1620-20220511165114870.png)

### Annotation

一个 Span 可以包含多个 Annotation，每个 Annotation 表示一个特殊事件，比如：

  ![](https://gitee.com/littlefxc/oss/raw/master/images/1620.png)
...
![](https://gitee.com/littlefxc/oss/raw/master/images/5e13fec609dfb60018761582.png)
...
![](https://gitee.com/littlefxc/oss/raw/master/images/architecture-1.png)
